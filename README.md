...
- `JQuery` for some dynamic stuff
- `AlpineJS` for some dynamic stuff
...
All the data stored in the database is dummy data generated by `Faker` library available in `Laravel` out of the box.
